...
import {IETF1} from "../Interfaces/IETF1.sol";
    ...
    IETF1
{
    ...
    function updateRedemption(uint256 orderId) external onlyRole(ETF_ADMIN) {}

    function executeRedemption(uint256 orderId) external onlyRole(ETF_ADMIN) {}

    function claimU(uint256 orderId) external nonReentrant {}
